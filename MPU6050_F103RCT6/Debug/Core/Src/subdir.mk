...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/Kalman.d ./Core/Src/Kalman.o ./Core/Src/Kalman.su ./Core/Src/TJ_MPU6050.d ./Core/Src/TJ_MPU6050.o ./Core/Src/TJ_MPU6050.su ./Core/Src/flash_storage.d ./Core/Src/flash_storage.o ./Core/Src/flash_storage.su ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/my_main.d ./Core/Src/my_main.o ./Core/Src/my_main.su ./Core/Src/stm32f1xx_hal_msp.d ./Core/Src/stm32f1xx_hal_msp.o ./Core/Src/stm32f1xx_hal_msp.su ./Core/Src/stm32f1xx_it.d ./Core/Src/stm32f1xx_it.o ./Core/Src/stm32f1xx_it.su ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f1xx.d ./Core/Src/system_stm32f1xx.o ./Core/Src/system_stm32f1xx.su
